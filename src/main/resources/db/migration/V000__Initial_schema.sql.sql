...
--
-- -- FUNCTION
-- Create Function ReservationCountByGuest(guestId int)
--     Returns int
--     language plpgsql
-- as
-- $$
...
--             from guest
--                      join reservation r
--                           on guest.id = r.guest_id
--             where guest_id = guestId);
-- end;
-- $$
--
-- --     //ֆունկցիայի կանչ
-- -- Select * FROM ReservationCountByGuest(1);
--
-- -- PROCEDURE
-- create or replace procedure completeReservation( reservation_id int )
--     language plpgsql
-- as $$
-- begin
--     update reservation
